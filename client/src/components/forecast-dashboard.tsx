import type { EngineeringForecast, ForecastHorizon, RiskLevel } from '@deploy-forecast/shared';
import { ArrowRight, CheckCircle2, Clock3, Gauge, ShieldAlert, Sparkles } from 'lucide-react';
...
export function ForecastDashboard({ forecast }: { forecast: EngineeringForecast }) {
  return (
    <div className="space-y-4" aria-live="polite">
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <Metric icon={Sparkles} label="Model" value={forecast.provider} />
      </div>
